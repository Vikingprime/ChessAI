...
public class Test {
	...
	public static void main(String[] args) {
		...
		mBoard.addPiece(new Rook(mBoard.getSquare(1, 1)),mBoard.getSetA());
		...
		mBoard.addPiece(new Rook(mBoard.getSquare(1, 8)),mBoard.getSetB());
	...
	//	System.out.println(coordinatea+" "+coordinateb);
	//	System.out.println(Board.instance().getSquare(coordinatea, coordinateb));
		Piece pawn = Board.instance().getSquare(coordinatea, coordinateb).getPiece();
	//	System.out.println("This is Pawn to String "+pawn.getSquare());
		//So the problem: Pieces exist properly in the list, but believe they're on wrong space on the board
